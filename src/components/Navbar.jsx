...
const Navbar = () => {
  ...
  return (
    <nav className="navbar bg-base-100 shadow-lg shadow-base-300 min-h-[10vh] px-5 fixed z-[1000] top-0">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          >
            ...
            <li>
              <Link onClick={() => dispatch(toggleTheme())}>Toggle Theme</Link>
            </li>
          </ul>
        </div>
      ...
      <div className="navbar-end gap-5 hidden lg:flex">
        {auth ? (
          ...
          <>
            ...
            <Link to="/login">
              <button className="btn btn-primary w-[7em]">Sign In</button>
            </Link>
          </>
        )}
